    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_product', to='food_choice.product')),
                ('substitute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='favorite_substitute', to='food_choice.product')),
            ],
        ),
        migrations.AddConstraint(
            model_name='favoris',
            constraint=models.UniqueConstraint(fields=('product', 'substitute', 'owner'), name='unique_user_favorite'),
        ),
    ]
